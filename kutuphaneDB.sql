...
VALUES (1, 101, 201, '2023-06-01', '2023-06-10'),
	   ...
	   (8, 108, 208, '2023-06-08', '2023-06-18');
...
VALUES (101, 'Ahmet', 'Yýlmaz', 'Erkek', '2002-01-10', '12. Sýnýf'),
	   ...
	   (108, 'Berkant', 'Gunes', 'Erkek', '1996-01-01', 'CEO');
...
VALUES (201, '9786052980001', 'Kýrmýzý Pazartesi', 1, 1, 300, 8),
	   ...
	   (208, '9789750738509', 'Benim Gozumden Dunya', 8, 1, 500, 9);
...
-- SORGU: George Orwell kitaplarini listele
SELECT k.kitapadi from kitap k
inner join yazar y on y.yazarno=k.yazarno
where y.yazarad = 'George' and y.yazarsoyad = 'Orwell'

-- SORGU: Einsteinin kitaplarini alan ogrencilerin adi ve soyadini listele (yani ograd ogrsoyad lazim, islem,kitap lazim ve yazar adi einstein olmali)
SELECT o.ograd, o.ogrsoyad From Ogrenci o
inner join islem i on o.ogrno=i.ogrno     -- ogrno uzerinden ogrenci tablosunu islemle bagladik
inner join kitap k on k.kitapno=i.kitapno -- islem tablosunu da kitap tablosuyla bagladik, islem tablosu burada ara tablo oldu
inner join yazar y on k.yazarno = y.yazarno
where y.yazarad = 'Albert' and yazarsoyad = 'Einstein';
